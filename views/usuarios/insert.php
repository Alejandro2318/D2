        ...
        <div class="formulario__cont">
            <div class="formulario__cont2">
                <div  class="formulario__cont-sec">
                    ...
                    <input type="text" class="formulario__cont-input form-control" id="nombre_usuario" name="nombre_usuario" required>
                </div>
                <div class="formulario__cont-sec">
                    <label for="contraseña" class="form-label">Contraseña</label>
                    <input type="text" class="formulario__cont-input form-control" id="contraseña" name="contraseña" required>
                </div>
